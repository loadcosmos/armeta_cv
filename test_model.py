"""
Test YOLOv8 model on real PDF documents
...
# ============= CONFIGURATION =============
MODEL_PATH = '/kaggle/working/armeta_cv/runs/detect/train2/weights/best.pt'
PDF_DIR = Path('/kaggle/input/armeta-docs/data/pdf')
OUTPUT_DIR = Path('/kaggle/working/test_results')
DPI = 200

# Test on first N PDFs
NUM_PDFS_TO_TEST = 5
...
def main():
    print("=" * 70)
    print("🧪 TESTING YOLOV8 MODEL ON PDF DOCUMENTS")
    print("=" * 70)
    ...
    # Get PDF files
    pdf_files = sorted(list(PDF_DIR.glob('*.pdf')))[:NUM_PDFS_TO_TEST]
